...
export default function DataTable({...rest}) {
    function openNav() {
     rest.sideDrawerRef.style.width = "250px";
    }
    ...
    rows: [
      {
        ...
        action: (
          <td>
            <Edit style={{cursor:'pointer', marginInline:'3px'}} color='blue' size={15} />{" "}
      ...
      },
      {
        ...
        action: (
          <td>
            <Edit style={{cursor:'pointer', marginInline:'3px'}} onClick={()=>{
                openNav()
      ...
      },
      {
        ...
        action: (
          <td>
            <Edit style={{cursor:'pointer', marginInline:'3px'}} color='blue' size={15} /> <Trash color='red'  size={15} />
          </td>
        ),
      },
      {
